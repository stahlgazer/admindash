...
import { BrowserTemplate } from "../../components/BrowserTemplate";
      ...
      <div className="bg-white w-[1440px] h-[1246px]">
        <div className="relative h-[1246px]">
          <div className="absolute w-[1440px] h-[1246px] top-0 left-0">
            ...
            <Expand className="!absolute !w-[16px] !h-[16px] !top-[78px] !left-[77px]" />
            <div className="absolute w-[12px] h-[58px] top-[353px] left-0 bg-[#6696d1] rounded-[8px]" />
            ...
            <img
              ...
              src="https://c.animaapp.com/U7DZF6MV/img/divide-line-1.svg"
            />
            <BrowserTemplate className="!absolute !left-0 !w-[1440px] !top-0" overlapGroupClassName="!w-[1330px]" />
